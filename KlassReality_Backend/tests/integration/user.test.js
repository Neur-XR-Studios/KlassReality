...
describe('User routes', () => {
  ...
  describe('GET /v1/users', () => {
    ...
    test('should correctly sort the returned array if descending sort param is specified', async () => {
      ...
      expect(res.body.results).toHaveLength(3);
      expect(res.body.results[0].id).toEqual(userOne._id.toHexString());
      expect(res.body.results[1].id).toEqual(userTwo._id.toHexString());
      expect(res.body.results[2].id).toEqual(admin._id.toHexString());
    });
